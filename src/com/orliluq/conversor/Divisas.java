...
public class Divisas {
    ...
    ImageIcon icon = new ImageIcon(getClass().getResource("/com/orliluq/icons/icon-divisa.png"));
    ImageIcon iconM = new ImageIcon(getClass().getResource("/com/orliluq/icons/icon-error.png"));
